...
namespace MyoCapture
{
    ...
    public class DataHandler
    {
        ...
        public async void Prep_EMG_Datastream(string deviceName, string sessionId)
        {
            ...
            string localFolder = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetEntryAssembly().Location), "Data", "EMG");
        ...
        {
            string localFolder = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetEntryAssembly().Location), "Data", "IMU");
